...
\newcommand{\match}[3]{#1 \;;\; #2 \quad\rightharpoonup\quad #3}
...
\begin{itembox}[c]{Constraint--Based Type Inference rules}
  ...
  \begin{center}
    \begin{bprooftree}
      \AxiomC{$\Gamma(x)=T$}
      \LeftLabel{Variable}
      \UnaryInfC{$\infer{\Gamma}{x:T}{\Gamma\setminus (x:T)}{\{\}}{\{\}}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
...
\begin{itembox}[c]{Term Matching and Substitution}
  ...
  \begin{center}
      \begin{bprooftree}
        \AxiomC{$　$}
        \UnaryInfC{$\match{\varnothing}{\varnothing}{\{\}}$}
      \end{bprooftree}
      \begin{bprooftree}
        \AxiomC{$　$}
  ...
  \begin{center}
      \begin{bprooftree}
        \AxiomC{$\match{t}{u}{\Xi}$}
        \UnaryInfC{$\match{t^\dagger}{u^\dagger}{\Xi}$}
      \end{bprooftree}
      \begin{bprooftree}
        \AxiomC{$\subst{\Xi}{t}{t'}{\Xi'}$}
