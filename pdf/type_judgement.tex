...
\newcommand{\decomp}{\mathop{\mathrm{decomp}}\nolimits}
...
\begin{figure}[H]
  ...
  \begin{center}
    \begin{bprooftree}
      ...
      \LeftLabel{$\mathrm{I}_L$}
      \UnaryInfC{$\sequent{\Gamma,\text{()}:\mathrm{I}}{t:T}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\text{　}$}
      \RightLabel{$\mathrm{I}_R$}
      \UnaryInfC{$\sequent{}{\text{()}:\mathrm{I}}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
...
\begin{figure}[H]
  ...
  \begin{center}
    \begin{bprooftree}
      ...
      \LeftLabel{$\mathrm{I}_L$}
      \UnaryInfC{$\nsequent{\Gamma,\text{()}:\mathrm{I}}{t:T}{\Gamma'}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\text{　}$}
      \RightLabel{$\mathrm{I}_R$}
      \UnaryInfC{$\nsequent{\Gamma}{\text{()}:\mathrm{I}}{\Gamma}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
...
\begin{figure}[H]
  ...
  \begin{center}
    \begin{bprooftree}
      ...
      \LeftLabel{$\mathrm{I}_L$}
      \UnaryInfC{$\infer{\Gamma,\text{()}:V}{t:T}{\Gamma'}{\chi}{C\cup\{V=\mathrm{I}\}}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\text{　}$}
      \RightLabel{$\mathrm{I}_R$}
      \UnaryInfC{$\infer{\Gamma}{\text{()}:V}{\Gamma}{\{\}}{\{V=\mathrm{I}\}}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
