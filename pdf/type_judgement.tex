...
\begin{itembox}[c]{Operational Sematics}
  ...
  \begin{center}
    ...
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{\text{inl}\;t_1}{t_1'}$}
      \AxiomC{$\equi{\text{inl}\;t_2}{t_2'}$}
      \BinaryInfC{$\equi{\text{inl}\;(t_1+t_2)}{t_1'+t_2'}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t}{t'}$}
      \UnaryInfC{$\equi{\text{inl}\;t}{\text{inl}\;t'}$}
  ...
  \begin{center}
    ...
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{\text{inr}\;t_1}{t_1'}$}
      \AxiomC{$\equi{\text{inr}\;t_2}{t_2'}$}
      \BinaryInfC{$\equi{\text{inr}\;(t_1+t_2)}{t_1'+t_2'}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t}{t'}$}
      \UnaryInfC{$\equi{\text{inr}\;t}{\text{inr}\;t'}$}
  ...
  \begin{center}
    ...
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1\times{}t_3}{t_{13}}$}
      \AxiomC{$\equi{t_2\times{}t_3}{t_{23}}$}
      \BinaryInfC{$\equi{(t_1+t_2)\times{}t_3}{t_{13}+t_{23}}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1\times{}t_2}{t_{12}}$}
      \AxiomC{$\equi{t_1\times{}t_3}{t_{13}}$}
      \BinaryInfC{$\equi{t_1\times{}(t_2+t_3)}{t_{12}+t_{13}}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1}{t_1'}$}
      \AxiomC{$\equi{t_2}{t_2'}$}
  ...
  \begin{center}
    ...
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1\mapsto{}t_3}{t_{13}}$}
      \AxiomC{$\equi{t_2\mapsto{}t_3}{t_{23}}$}
      \BinaryInfC{$\equi{(t_1+t_2)\mapsto{}t_3}{t_{13}+t_{23}}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1\mapsto{}t_2}{t_{12}}$}
      \AxiomC{$\equi{t_1\mapsto{}t_3}{t_{13}}$}
      \BinaryInfC{$\equi{t_1\mapsto{}(t_2+t_3)}{t_{12}+t_{13}}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1}{t_1'}$}
      \AxiomC{$\equi{t_2}{t_2'}$}
  ...
  \begin{center}
    ...
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{\text{fold}\;t_1}{t_1'}$}
      \AxiomC{$\equi{\text{fold}\;t_2}{t_2'}$}
      \BinaryInfC{$\equi{\text{fold}\;(t_1+t_2)}{t_1'+t_2'}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t}{t'}$}
      \UnaryInfC{$\equi{\text{fold}\;t}{\text{fold}\;t'}$}
  ...
  \begin{center}
    ...
    \begin{bprooftree}
      ...
      \AxiomC{$\equi{t_2}{t_2'}$}
      \AxiomC{$\equi{t_3}{t_3'}$}
      \TrinaryInfC{$\equi{(t_1+t_2)+t_3}{t_3'+(t_1'+t_2')}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1}{t_1'}$}
      \AxiomC{$\equi{t_2}{t_2'}$}
  ...
  \begin{center}
    ...
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1\fcmp{}t_2}{t_{12}}$}
      \AxiomC{$\equi{t_1\fcmp{}t_3}{t_{13}}$}
      \BinaryInfC{$\equi{t_1\fcmp(t_2+t_3)}{t_{12}+t_{13}}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\equi{t_1\fcmp{}t_3}{t_{13}}$}
      \AxiomC{$\equi{t_2\fcmp{}t_3}{t_{23}}$}
      \BinaryInfC{$\equi{(t_1+t_2)\fcmp{}t_3}{t_{13}+t_{23}}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
