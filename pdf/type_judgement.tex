...
\begin{tabular}{lcc}
  ...
  \vcenteredhbox{
    \begin{tikzpicture}
      ...
      \draw (1,0.5) rectangle (2,-1.5) node[pos=.5, align=center]{$f$ \\\smallskip\\ $\times$ \\\smallskip\\ $g$};
      \fill (1,0.5) rectangle (1.25,0.25);
  ...
  \begin{bprooftree}
    \AxiomC{}
    \UnaryInfC{$\langle{\langle\rangle,v}\rangle \quad unit_\otimes \quad v$}
  \end{bprooftree} &
  \vcenteredhbox{
    \begin{tikzpicture}
  ...
  \begin{bprooftree}
    \AxiomC{}
    \UnaryInfC{$\langle{v_1,\langle{v_2,v_3}\rangle}\rangle \quad assoc_\otimes \quad \langle{\langle{v_1,v_2}\rangle,v_3}\rangle$}
  \end{bprooftree} &
  \vcenteredhbox{
    \begin{tikzpicture}
      \draw[middlearrow={>}{above}{$T_1$}] (0,0)--(1,0);
  ...
  \begin{bprooftree}
    \AxiomC{}
    \UnaryInfC{$\langle{v_1,v_2}\rangle \quad sym_\otimes \quad \langle{v_2,v_1}\rangle$}
  \end{bprooftree} &
  \vcenteredhbox{
    \begin{tikzpicture}
      \draw[middlearrow={>}{above}{$T_1$}] (0,0)--(1,0);
  ...
  \begin{bprooftree}
    \AxiomC{}
    \UnaryInfC{$\langle{v,\langle\rangle/v}\rangle \quad eval \quad \langle\rangle$}
  \end{bprooftree} &
  \vcenteredhbox{
    \begin{tikzpicture}
      \draw[middlearrow={>}{above}{$T$}] (0,0)--(1,0);
  ...
  \begin{tabular}{c}
    \begin{bprooftree}
      \AxiomC{$v \quad f \quad v'$}
      \UnaryInfC{$\langle{\text{left}\;v}\rangle \quad f+g \quad \langle{\text{left}\;v'}\rangle$}
    \end{bprooftree} \\ \\
    \begin{bprooftree}
      \AxiomC{$v \quad g \quad v'$}
      \UnaryInfC{$\langle{\text{right}\;v}\rangle \quad f+g \quad \langle{\text{right}\;v'}\rangle$}
    \end{bprooftree}
  \end{tabular} &
  \vcenteredhbox{
    \begin{tikzpicture}
...
%  \begin{bprooftree}
%    \AxiomC{}
%    \UnaryInfC{$\langle{\text{right}\;v}\rangle \quad unit_\oplus \quad v$}
%  \end{bprooftree} &
%  \vcenteredhbox{
%    \begin{tikzpicture}
%      \draw[middlearrow={>}{above}{$O$}] (0,0)--(1,0);
%      \draw[middlearrow={>}{above}{$T$}] (0,-1)--(1,-1);
%      \draw (1,0.5) rectangle (2,-1.5) node[pos=.5]{$unit_\oplus$};
%      \fill (1,0.5) rectangle (1.25,0.25);
%      \draw[middlearrow={>}{above}{$T$}] (2,-1)--(3,-1);
%    \end{tikzpicture}
%  } \\ \\
  ...
  \begin{tabular}{c}
    \begin{bprooftree}
      \AxiomC{}
      \UnaryInfC{$\langle{\text{left}\;v}\rangle \quad assoc_\oplus \quad \langle{\text{left}\;\langle{\text{left}\;v}\rangle}\rangle$}
    \end{bprooftree} \\ \\
    \begin{bprooftree}
      \AxiomC{}
      \UnaryInfC{$\langle{\text{right}\;\langle{\text{left}\;v}\rangle}\rangle \quad assoc_\oplus \quad \langle{\text{left}\;\langle{\text{right}\;v}\rangle}\rangle$}
    \end{bprooftree} \\ \\
    \begin{bprooftree}
      \AxiomC{}
      \UnaryInfC{$\langle{\text{right}\;\langle{\text{right}\;v}\rangle}\rangle \quad assoc_\oplus \quad \langle{\text{right}\;v}\rangle$}
    \end{bprooftree}
  \end{tabular} &
  \vcenteredhbox{
    \begin{tikzpicture}
  ...
  \begin{tabular}{c}
    \begin{bprooftree}
      \AxiomC{}
      \UnaryInfC{$\langle{\text{left}\;v}\rangle \quad sym_\oplus \quad \langle{\text{right}\;v}\rangle$}
    \end{bprooftree} \\ \\
    \begin{bprooftree}
      \AxiomC{}
      \UnaryInfC{$\langle{\text{right}\;v}\rangle \quad sym_\oplus \quad \langle{\text{left}\;v}\rangle$}
    \end{bprooftree}
  \end{tabular} &
  \vcenteredhbox{
    \begin{tikzpicture}
  ...
  \begin{tabular}{c}
    \begin{bprooftree}
      \AxiomC{$\langle{\text{right}\;v_1}\rangle \quad f;loop\;f \quad \langle{\text{right}\;v_3}\rangle$}
      \UnaryInfC{$v_1 \quad trace\;f \quad v_3$}
    \end{bprooftree} \\ \\
    \begin{bprooftree}
      \AxiomC{$\langle{\text{left}\;v_2}\rangle \quad f;loop\;f \quad v$}
      \UnaryInfC{$\langle{\text{left}\;v_2}\rangle \quad loop\;f \quad v$}
    \end{bprooftree} \\ \\
    \begin{bprooftree}
      \AxiomC{}
      \UnaryInfC{$\langle{\text{right}\;v_3}\rangle \quad loop\;f \quad \langle{\text{right}\;v_3}\rangle$}
    \end{bprooftree}
  \end{tabular} &
  \vcenteredhbox{
    \begin{tikzpicture}
      \draw (0,0.75)--(3,0.75);
      \draw (0,0.75) to[bend right=90] (0,0);
      \draw (3,0.75) to[bend left=90] (3,0);
      \draw[middlearrow={>}{above}{$T_2$}] (0,0)--(1,0);
      \draw[middlearrow={>}{above}{$T_1$}] (-1,-1)--(1,-1);
      \draw (1,0.5) rectangle (2,-1.5) node[pos=.5]{$f$};
      \fill (1,0.5) rectangle (1.25,0.25);
      \draw[middlearrow={>}{above}{$T_2$}] (2,0)--(3,0);
      \draw[middlearrow={>}{above}{$T_3$}] (2,-1)--(4,-1);
    \end{tikzpicture}
  } \\ \\
  ...
  \begin{tabular}{c}
    \begin{bprooftree}
      \AxiomC{}
      \UnaryInfC{$\langle{\langle{\text{left}\;v_1}\rangle,v_3}\rangle \quad distrib \quad \langle{\text{left}\;\langle{v_1,v_3}\rangle}\rangle$}
    \end{bprooftree} \\ \\
    \begin{bprooftree}
      \AxiomC{}
      \UnaryInfC{$\langle{\langle{\text{right}\;v_2}\rangle,v_3}\rangle \quad distrib \quad \langle{\text{right}\;\langle{v_2,v_3}\rangle}\rangle$}
    \end{bprooftree}
  \end{tabular} &
  \vcenteredhbox{
    \begin{tikzpicture}
