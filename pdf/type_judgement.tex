...
\begin{itembox}[c]{Term Typing rules}
  ...
  \begin{center}
    \begin{bprooftree}
      \AxiomC{$\sequent{\Gamma,u:U}{t:T}$}
      \LeftLabel{$\text{Opposition}_L$}
      \UnaryInfC{$\sequent{\Gamma,-u:U}{t:T}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\sequent{\Gamma}{t:T}$}
      \RightLabel{$\text{Opposition}_R$}
      \UnaryInfC{$\sequent{\Gamma}{-t:T}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
      ...
      \UnaryInfC{$\sequent{\Gamma,u\;\text{trace}\;S:U_1\multimap{}U_2}{t:T}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\sequent{\Gamma}{t:U\oplus{}T_1\multimap{}U\oplus{}T_2}$}
      \RightLabel{$\text{Trace}_R$}
      \UnaryInfC{$\sequent{\Gamma}{t\;\text{trace}\;U:T_1\multimap{}T_2}$}
    \end{bprooftree}
  \end{center}
\end{itembox}
...
\begin{itembox}[c]{Operational Semantics}
  ...
  \begin{center}
    \begin{bprooftree}
      \AxiomC{$\match{v}{u}{[\Xi]}$}
      \LeftLabel{Match--opp--c}
      \UnaryInfC{$\match{-v}{-u}{[\Xi]}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\subst{[\Xi]}{v}{v'}$}
      \RightLabel{Subst--opp}
      \UnaryInfC{$\subst{[\Xi]}{-v}{-v'}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
      \AxiomC{$\match{v}{-u}{[\Xi]}$}
      \LeftLabel{Match--opp--l}
      \UnaryInfC{$\match{-v}{u}{[\Xi]}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
  ...
  \begin{center}
    \begin{bprooftree}
      ...
      \UnaryInfC{$\match{t\;\text{trace}\;T}{u\;\text{trace}\;T}{[\Xi]}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\subst{[\Xi]}{t}{t'}$}
      \RightLabel{Subst--trace}
      \UnaryInfC{$\subst{[\Xi]}{t\;\text{trace}\;T}{t'\;\text{trace}\;T}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
  ...
  \begin{center}
    \begin{bprooftree}
      ...
      \UnaryInfC{$\reduction{(t\;\text{trace}\;X)\;\text{@}\;u}{u'}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\reduction{t\;\text{@}\;(\text{inl}\;u)}{\text{inl}\;u'}$}
      \AxiomC{$\reduction{(t\;\text{trace}\;X)\;\text{@}\;(\text{inl}\;u')}{u''}$}
      \RightLabel{App--trace--loop}
      \BinaryInfC{$\reduction{(t\;\text{trace}\;X)\;\text{@}\;\text{inl}\;u}{u''}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
      ...
      \BinaryInfC{$\reduction{(t\;\text{trace}\;X)\;\text{@}\;u}{u''}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\reduction{t\;\text{@}\;(\text{inl}\;u)}{\text{inr}\;u'}$}
      \RightLabel{App--trace--end}
      \UnaryInfC{$\reduction{(t\;\text{trace}\;X)\;\text{@}\;\text{inl}\;u}{u'}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
  ...
  \begin{center}
    ...
    \begin{bprooftree}
      ...
      \UnaryInfC{$\flip{(t\;\text{trace}\;X)^\dagger}{t'\;\text{trace}\;X}$}
    \end{bprooftree}
  \end{center}
\end{itembox}
...
\begin{itembox}[c]{Term Typing rules}
  ...
  \begin{center}
    \begin{bprooftree}
      ...
      \LeftLabel{$\text{Trace}_L$}
      \UnaryInfC{$\nsequent{\Gamma,u\;\text{trace}\;S:U_1\multimap{}U_2}{t:T}{\Gamma'}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\nsequent{\Gamma}{t:U\oplus{}T_1\multimap{}U\oplus{}T_2}{\Gamma'}$}
      \RightLabel{$\text{Trace}_R$}
      \UnaryInfC{$\nsequent{\Gamma}{t\;\text{trace}\;U:T_1\multimap{}T_2}{\Gamma'}$}
    \end{bprooftree}
  \end{center}
\end{itembox}
