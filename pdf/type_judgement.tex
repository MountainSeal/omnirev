...
\begin{itembox}[c]{Term Typing rules}
  ...
  \begin{center}
    \begin{bprooftree}
      ...
      \UnaryInfC{$\sequent{\Gamma,u\;\text{trace}_S:U_1\multimap{}U_2}{t:T}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\sequent{\Gamma}{t:U\oplus{}T_1\multimap{}U\oplus{}T_2}$}
      \RightLabel{$\text{Trace}_R$}
      \UnaryInfC{$\sequent{\Gamma}{t\;\text{trace}_U:T_1\multimap{}T_2}$}
    \end{bprooftree}
  \end{center}
\end{itembox}
...
\begin{itembox}[c]{Equivalence relation}
  ...
  \begin{center}
    ...
    \begin{bprooftree}
      \AxiomC{$\equi{t_1}{t_2}$}
      \UnaryInfC{$\equi{t_1+-t_2}{\varnothing}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$　$}
  ...
  \begin{center}
    ...
    \begin{bprooftree}
      \AxiomC{$\equi{t}{t'}$}
      \UnaryInfC{$\equi{t\;\text{trace}_T}{t'\;\text{trace}_T}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
  ...
  \begin{center}
    \begin{bprooftree}
      \AxiomC{$　$}
      \UnaryInfC{$\equi{-(t_1+t_2)}{-t_1+-t_2}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
  ...
  \begin{center}
    \begin{bprooftree}
      \AxiomC{$　$}
      \UnaryInfC{$\equi{-(t_1\times{}t_2)}{(-t_1)\times{}(-t_2)}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$　$}
      \UnaryInfC{$\equi{-(t_1\mapsto{}t_2)}{(-t_1)\mapsto{}(-t_2)}$}
    \end{bprooftree}
  \end{center}
  \begin{center}
    \begin{bprooftree}
...
\begin{itembox}[c]{partial order}
  ...
  %   \begin{bprooftree}
  %     \AxiomC{$\precedes{t}{t'}$}
  %     \UnaryInfC{$\precedes{\text{inl}\;t}{\text{inl}\;t'}$}
  %   \end{bprooftree}
  %   \begin{bprooftree}
  %     \AxiomC{$\precedes{t}{t'}$}
  %     \UnaryInfC{$\precedes{\text{inr}\;t}{\text{inr}\;t'}$}
  %   \end{bprooftree}
  % \end{center}
\end{itembox}
...
\begin{itembox}[c]{Term Typing rules}
  ...
  \begin{center}
    \begin{bprooftree}
      ...
      \LeftLabel{$\text{Trace}_L$}
      \UnaryInfC{$\nsequent{\Gamma,u\;\text{trace}_S:U_1\multimap{}U_2}{t:T}{\Gamma'}$}
    \end{bprooftree}
    \begin{bprooftree}
      \AxiomC{$\nsequent{\Gamma}{t:U\oplus{}T_1\multimap{}U\oplus{}T_2}{\Gamma'}$}
      \RightLabel{$\text{Trace}_R$}
      \UnaryInfC{$\nsequent{\Gamma}{t\;\text{trace}_U:T_1\multimap{}T_2}{\Gamma'}$}
    \end{bprooftree}
  \end{center}
\end{itembox}
